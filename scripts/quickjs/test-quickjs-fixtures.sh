...
tail -n +2 "$registry" | while IFS= read -r line; do
    ...
    [[ "$fixture" =~ ^apps/cli/tests/fixtures/inputs/[a-z0-9_]+\.js$ ]] \
        || die "invalid fixture path for $id: $fixture"
    [[ "$expected" =~ ^apps/cli/tests/fixtures/expected/[a-z0-9_]+\.quickjs-2026-06-04\.txt$ ]] \
    ...
    [[ "$expected" == "apps/cli/tests/fixtures/expected/$fixture_stem.quickjs-2026-06-04.txt" ]] \
