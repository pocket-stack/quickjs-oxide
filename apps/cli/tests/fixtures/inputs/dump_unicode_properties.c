 ...
 *
 * This file is compiled only by scripts/unicode/generate-unicode-property-tables.sh.
...
int main(void)
{
    printf("// @generated by scripts/unicode/generate-unicode-property-tables.sh.\n");
