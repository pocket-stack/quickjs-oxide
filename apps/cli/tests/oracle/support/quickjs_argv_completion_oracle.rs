...
#[allow(dead_code)]
pub(crate) fn observe_completion_argv_trim_end(
    oracle: &OsStr,
    source: &str,
    description: &str,
) -> String {
...
#[allow(dead_code)]
pub(crate) fn observe_completion_argv_strip_one_lf(
    oracle: &OsStr,
    source: &str,
    description: &str,
) -> String {
...
#[allow(dead_code)]
pub(crate) fn observe_completion_argv_sequence_strip_one_lf(
    oracle: &OsStr,
    sources: &[&str],
    description: &str,
) -> String {
