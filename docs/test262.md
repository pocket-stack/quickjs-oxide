...
1. **Full pass:** 79,509 / 102,037 (77.922%). Every frozen Test262 variant is in
   the denominator.
2. **Eligible coverage:** 79,559 / 102,037 (77.971%). This measures how much of
   the full vector the current profile admits to execution.
3. **Runnable pass quality:** 79,509 / 79,559 (99.937%). This is useful for
...
```text
fail-parse=7 fail-runtime=43 pass=79509 skipped-config-exclude=6700 skipped-feature=11775 unsupported-feature=1050 unsupported-module=391 unsupported-negative-provenance=2562
```
