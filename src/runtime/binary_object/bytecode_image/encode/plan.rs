...
use super::super::budget::{
    ...
    ModuleResourceKind, ModuleTotals, ModuleUsage,
};
use super::super::model::{
    BytecodeImage, FunctionId, FunctionRecord, ImageCode, ImageFunctionEnvelope, ImageOpaque,
    ImageValue, ModuleId, ModuleRecord,
};
use super::emit::encoded_plan_length;
use super::{BytecodeImageEncodeError, BytecodeImageEncodeOptions, ModuleIntegerField};
