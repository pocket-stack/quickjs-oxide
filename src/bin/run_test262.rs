...
const TEST262_AGENT_STAGE_A_PARENT_PROFILE_SHA256: &str =
    "ae525546ca879c3f159d491df0a95e3df8bef438f70908057ab10c90ca1545e4";
const TEST262_AGENT_STAGE_A_CANDIDATE_PROFILE_SHA256: &str =
    "7254bdc5a52a30f70f270bdabc9337231c94799d636f993ba54b8ae082915dea";
const TEST262_AGENT_STAGE_A_UNIVERSE_SHA256: &str =
    "39774992fb157df3676b53c4c001c7f9cb60ca546309b0e8be18ff3ac9737151";
const TEST262_AGENT_STAGE_A_ACTIVATION_SHA256: &str =
    "cc8da184af01572cb83fc743f062fb54c17124663358532ccb2216587e62bb58";
const TEST262_AGENT_STAGE_A_GLOBAL_PARENT_PROFILE_SHA256: &str =
...
const TEST262_ERROR_REGEXP_TYPEDARRAY_GLOBAL_CANDIDATE_PROFILE_SHA256: &str =
    "280264ae035da45cd0e2727b981e64380496ed75af3216208616dfee82d0459a";
const TEST262_ERROR_REGEXP_TYPEDARRAY_GLOBAL_MANIFEST_SHA256: &str =
    "9fca0f3c6dbb4a36d6e1e3d12fff75503aafecb2f7a2fcd1606fc2fa0060c7c1";
const TEST262_SHARED_ATOMICS_GLOBAL_PARENT_PROFILE_SHA256: &str =
    "280264ae035da45cd0e2727b981e64380496ed75af3216208616dfee82d0459a";
const TEST262_SHARED_ATOMICS_GLOBAL_CANDIDATE_PROFILE_SHA256: &str =
    "47cf8351f7844340bbbff3ba9bb781faf552f8f27d0dd6cca2e35dbf9ad48232";
const TEST262_SHARED_ATOMICS_GLOBAL_MANIFEST_SHA256: &str =
    "c89bf36101fc9f369f703d9f27faecdda9c520463d08f78b1484c170d12d17e5";
...
fn run_coordinator(options: &CoordinatorOptions) -> Result<bool, String> {
    ...
    let oxide_profile_kind = identify_oxide_profile(&options.oxide_profile)?;
...
enum OxideProfileKind {
    ...
    SharedAtomicsGlobalParent,
    SharedAtomicsGlobalCandidate,
}
...
fn identify_oxide_profile(path: &Path) -> Result<OxideProfileKind, String> {
    ...
    let profiles = [
        ...
        (
            root.join("tests/test262-agent-stage-a-parent.conf"),
            OxideProfileKind::AgentStageAParent,
        ),
        (
            root.join("tests/test262-agent-stage-a-candidate.conf"),
            OxideProfileKind::AgentStageACandidate,
        ),
        (
            root.join("tests/test262-agent-stage-a-global-parent.conf"),
            OxideProfileKind::AgentStageAGlobalParent,
        ),
        (
        ...
        (
            root.join("tests/test262-error-regexp-typedarray-global-candidate.conf"),
            OxideProfileKind::ErrorRegExpTypedArrayGlobalCandidate,
        ),
        (
            root.join("tests/test262-shared-atomics-global-parent.conf"),
            OxideProfileKind::SharedAtomicsGlobalParent,
        ),
        (
            root.join("tests/test262-shared-atomics-global-candidate.conf"),
            OxideProfileKind::SharedAtomicsGlobalCandidate,
        ),
    ];
...
fn verify_oxide_profile(options: &CoordinatorOptions) -> Result<&'static str, String> {
    match identify_oxide_profile(&options.oxide_profile)? {
        ...
        OxideProfileKind::AgentStageAParent => verify_scoped_pinned_manifests(
            options,
            "Test262 agent Stage A parent",
            TEST262_AGENT_STAGE_A_PARENT_PROFILE_SHA256,
            &[
                (
                    "tests/test262-agent-stage-a-universe.txt",
                    TEST262_AGENT_STAGE_A_UNIVERSE_SHA256,
                ),
                (
                    "tests/test262-agent-stage-a.txt",
                    TEST262_AGENT_STAGE_A_ACTIVATION_SHA256,
                ),
            ],
        ),
        OxideProfileKind::AgentStageACandidate => verify_scoped_pinned_manifests(
            options,
            "Test262 agent Stage A candidate",
            TEST262_AGENT_STAGE_A_CANDIDATE_PROFILE_SHA256,
            &[
                (
                    "tests/test262-agent-stage-a-universe.txt",
                    TEST262_AGENT_STAGE_A_UNIVERSE_SHA256,
        ...
        OxideProfileKind::AgentStageAGlobalParent => verify_tag_transition_profile(
            options,
            "Test262 agent Stage A global admission",
            "parent",
        ...
        OxideProfileKind::AgentStageAGlobalCandidate => verify_tag_transition_profile(
            options,
            "Test262 agent Stage A global admission",
            "candidate",
        ...
        OxideProfileKind::AtomicsPauseGlobalCandidate => verify_tag_transition_profile(
            ...
            &[
                ...
                (
                    "tests/test262-error-regexp-typedarray-global.txt",
                    TEST262_ERROR_REGEXP_TYPEDARRAY_GLOBAL_MANIFEST_SHA256,
                ),
            ],
        ),
        OxideProfileKind::ErrorRegExpTypedArrayGlobalCandidate => verify_tag_transition_profile(
            options,
            "Error.isError, RegExp.escape, and TypedArray.prototype.at global admission",
            "candidate",
            ...
            &[
                ...
                (
                    "tests/test262-shared-atomics-global.txt",
                    TEST262_SHARED_ATOMICS_GLOBAL_MANIFEST_SHA256,
                ),
            ],
        ),
        OxideProfileKind::SharedAtomicsGlobalParent => verify_tag_transition_profile(
            options,
            "SharedArrayBuffer and Atomics global admission",
            "parent",
            TEST262_SHARED_ATOMICS_GLOBAL_PARENT_PROFILE_SHA256,
            &[(
                "tests/test262-shared-atomics-global.txt",
                TEST262_SHARED_ATOMICS_GLOBAL_MANIFEST_SHA256,
            )],
        ),
        OxideProfileKind::SharedAtomicsGlobalCandidate => verify_tag_transition_profile(
            options,
            "SharedArrayBuffer and Atomics global admission",
            "candidate",
            TEST262_SHARED_ATOMICS_GLOBAL_CANDIDATE_PROFILE_SHA256,
            &[(
                "tests/test262-shared-atomics-global.txt",
                TEST262_SHARED_ATOMICS_GLOBAL_MANIFEST_SHA256,
            )],
...
mod cli_tests {
    ...
    fn only_pinned_global_and_scoped_profiles_are_accepted() {
        ...
        assert_eq!(
            identify_oxide_profile(Path::new("tests/test262-agent-stage-a-parent.conf")).unwrap(),
            OxideProfileKind::AgentStageAParent
        );
        assert_eq!(
            identify_oxide_profile(Path::new("tests/test262-agent-stage-a-candidate.conf"))
                .unwrap(),
            OxideProfileKind::AgentStageACandidate
        );
        assert_eq!(
            identify_oxide_profile(Path::new("tests/test262-agent-stage-a-global-parent.conf"))
                .unwrap(),
            OxideProfileKind::AgentStageAGlobalParent
        );
        assert_eq!(
        ...
        assert_eq!(
            identify_oxide_profile(Path::new("tests/test262-shared-atomics-global-parent.conf"))
                .unwrap(),
            OxideProfileKind::SharedAtomicsGlobalParent
        );
        assert_eq!(
    ...
    fn atomics_pause_global_profiles_require_the_exact_manifest_or_all() {
        ...
        let successor_manifest = scoped_profile_options(
            "tests/test262-atomics-pause-global-candidate.conf",
            "tests/test262-error-regexp-typedarray-global.txt",
        );
        assert_eq!(
            verify_oxide_profile(&successor_manifest).unwrap(),
            TEST262_ATOMICS_PAUSE_GLOBAL_CANDIDATE_PROFILE_SHA256
        );

        let parent_successor_manifest = scoped_profile_options(
            "tests/test262-atomics-pause-global-parent.conf",
            "tests/test262-error-regexp-typedarray-global.txt",
        );
        assert!(verify_oxide_profile(&parent_successor_manifest).is_err());
    }

    #[test]
    fn error_regexp_typedarray_global_candidate_requires_exact_manifest_or_all() {
        for selection in [
            [
                "--manifest",
                "tests/test262-error-regexp-typedarray-global.txt",
        ...
        for selection in [
            ["--test", "test/built-ins/Error/isError/basic.js"],
            ["--manifest", "tests/test262-atomics-pause-global.txt"],
            ["--manifest", "tests/test262-atomics-shared-deferred.txt"],
            ["--manifest", "Cargo.toml"],
        ] {
    ...
    #[test]
    fn shared_atomics_global_profiles_require_exact_manifest_or_all() {
    ...
    #[test]
    fn agent_stage_a_global_profiles_require_exact_universe_or_all() {
        for (profile, expected_sha256) in [
            (
                "tests/test262-agent-stage-a-global-parent.conf",
                TEST262_AGENT_STAGE_A_GLOBAL_PARENT_PROFILE_SHA256,
            ),
            (
                "tests/test262-agent-stage-a-global-candidate.conf",
