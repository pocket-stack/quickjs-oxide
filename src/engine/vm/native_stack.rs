...
use crate::engine::builtins::native::{
    NativeFunctionId, PrimitiveKind, RegExpNativeKind, TypedArrayNativeKind,
};
...
pub(crate) struct ModuleHostStackOverflow;
...
impl Runtime {
    ...
    pub(crate) fn proxy_method_stack_would_overflow(&self) -> bool {
    ...
    pub(crate) fn proxy_method_logical_stack_budget(&self) -> usize {
        let current = current_host_stack_address();
    ...
    pub(crate) fn bytecode_call_would_overflow(&self) -> bool {
        self.host_stack_would_overflow()
    }
    ...
    #[inline(never)]
    pub(crate) fn bytecode_stack_overflow_completion(
        &self,
    ...
    pub(crate) fn native_call_would_overflow(&self, target: NativeFunctionId) -> bool {
