...
impl RuntimeVmHost {
    pub(crate) fn active_home_object(&self) -> Result<Value, Error> {
        let function = self
            .current_function
            .as_ref()
    ...
    pub(crate) fn resolve_super_base(&self, home_object: Value) -> Result<Value, Error> {
    ...
    pub(crate) fn read_super_property(
        &mut self,
        receiver: Value,
        base: Value,
        key: Value,
    ...
    pub(crate) fn write_super_property(
        &mut self,
        receiver: Value,
        base: Value,
        key: Value,
