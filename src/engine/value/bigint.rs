...
pub const BC5_BIGINT_READ_MAX_BYTES: usize = (MAX_BIGINT_BITS / 8) as usize;

/// A failure while encoding or decoding a BC5 BigInt payload.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum Bc5BigIntCodecError {
...
impl JsBigInt {
    ...
    pub fn exceeds_allocation_limit(&self) -> bool {
    ...
    pub fn update_decrement(&self) -> Result<Self, BigIntError> {
