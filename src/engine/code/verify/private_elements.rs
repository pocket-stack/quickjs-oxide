...
use super::unlinked_closure_name;
use crate::engine::api::error::Error;
use crate::engine::api::runtime_error::RuntimeError;
use crate::engine::code::bytecode::{Instruction, PrivateNameSource};
use crate::engine::code::function::metadata::{
    ClassInitializerKind, ClosureSource, ClosureVariableKind, ConstructorKind, EvalKind,
    FunctionKind,
};
...
pub(crate) fn verify_unlinked(function: &UnlinkedFunction) -> Result<(), RuntimeError> {
...
mod tests {
    ...
    use crate::engine::code::function::metadata::{ClosureVariable, ClosureVariableName};
    ...
    fn private_method_function_with_shape(
        ...
        if include_brand {
            constants.push(UnlinkedConstant::child(UnlinkedFunction::fixture(
                vec![Instruction::Undefined, Instruction::Return],
                Vec::new(),
                FunctionMetadata {
                    max_stack: 1,
    ...
    fn private_accessor_function(
        ...
        .with_fixture_definitions(Vec::new(), definitions)
    }
    ...
    fn private_definition_requires_a_class_initializer_role() {
        ...
        let forged = UnlinkedFunction::fixture_with_closure_variables(
