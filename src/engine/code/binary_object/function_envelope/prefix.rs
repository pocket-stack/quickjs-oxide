...
pub(in crate::engine::code) struct FunctionEnvelopeLimits {
...
impl FunctionEnvelopeLimits {
    ...
    /// debug payload.
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn intersect_counts(
        self,
        max_local_variables: usize,
        max_closure_variables: usize,
        max_constant_pool_entries: usize,
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn intersect_code(
        self,
        max_bytes: usize,
    ...
    pub(in crate::engine::code::binary_object) const fn code_limit(
        self,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum FunctionResourceKind {
    LocalVariables,
    ClosureVariables,
    ConstantPoolEntries,
    Pc2LineBytes,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum FunctionField {
    FunctionFlags,
    ArgumentCount,
    VariableCount,
...
pub(in crate::engine::code) enum FunctionEnvelopeError {
    Wire(WireError),
    Code(CodeError),
    InvalidAtomMode {
...
pub(in crate::engine::code) fn read_function_record_prefix_after_tag<'input, C>(
    cursor: &mut C,
    atom_space: AtomIndexSpace,
...
pub(in crate::engine::code) fn write_function_record_prefix_after_tag(
