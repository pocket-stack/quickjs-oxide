...
pub(in crate::engine::code) enum ModuleField {
    LocalExportVariable,
...
pub(in crate::engine::code) enum BytecodeImageError {
    Wire(WireError),
    Atom(ImageAtomError),
...
pub(in crate::engine::code) fn decode_bytecode_image(
    input: &[u8],
    mode: ReaderMode,
...
pub(in crate::engine::code::binary_object) fn decode_bytecode_image_body<'input, C>(
    mut cursor: C,
    limits: BytecodeImageLimits,
    allow_object_references: bool,
