...
pub(in crate::engine::code) struct BytecodeImageEncodeOptions {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum ModuleIntegerField {
    RequestCount,
    ExportCount,
    ExportVariableIndex,
    ExportRequestIndex,
...
pub(in crate::engine::code) enum BytecodeImageEncodeError {
    Wire(WireError),
    Graph(GraphError),
...
pub(in crate::engine::code) fn encode_bytecode_image(
    image: &BytecodeImage,
