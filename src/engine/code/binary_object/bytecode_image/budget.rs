...
pub(in crate::engine::code) struct ModuleLimits {
    max_requests: usize,
    max_exports: usize,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum ModuleResourceKind {
    Requests,
    Exports,
    StarExports,
    Imports,
...
pub(in crate::engine::code) enum ModuleBudgetError {
    ResourceLimit {
        kind: ModuleResourceKind,
        requested: usize,
        limit: usize,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct BytecodeImageLimits {
    graph: GraphLimits,
...
impl BytecodeImageLimits {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn graph(self) -> GraphLimits {
        self.graph
    }
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum BytecodeImageResourceKind {
    Functions,
    Modules,
    WholeDepth,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum BytecodeImageBudgetError {
    ResourceLimit {
        kind: BytecodeImageResourceKind,
        requested: usize,
        limit: usize,
