...
pub(in crate::engine::code) struct FunctionId {
    source: MachineSource,
    index: u32,
}

impl FunctionId {
    pub(in crate::engine::code::binary_object) const fn source(self) -> MachineSource {
        self.source
    }
    ...
    #[must_use]
    pub(in crate::engine::code) const fn as_usize(self) -> usize {
        self.index as usize
    }
}
...
/// layers.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub(in crate::engine::code) struct ModuleId {
    source: MachineSource,
    index: u32,
}
...
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub(in crate::engine::code::binary_object) enum ImageOpaque {
    Function(FunctionId),
    Module(ModuleId),
}
...
pub(in crate::engine::code) struct ImageValue {
    kind: ImageValueKind,
}
...
impl ImageValue {
    pub(in crate::engine::code::binary_object) fn from_wire(value: WireValue) -> Self {
        Self {
            kind: ImageValueKind::Data(value),
        }
    }

    pub(in crate::engine::code::binary_object) const fn as_wire(
        &self,
    ...
    pub(in crate::engine::code::binary_object) fn into_wire(
        self,
    ) -> Result<WireValue, ImageOpaque> {
        match self.kind {
            ImageValueKind::Data(value) => Ok(value),
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn function_id(&self) -> Option<FunctionId> {
        match self.kind {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn module_id(&self) -> Option<ModuleId> {
        match self.kind {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn opaque(&self) -> Option<ImageOpaque> {
        match self.kind {
...
pub(in crate::engine::code) struct ImageInstructionSpan {
    offset: u32,
    opcode: PinnedOpcode,
}
...
impl ImageInstructionSpan {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn offset(self) -> u32 {
        self.offset
    }

    #[must_use]
    pub(in crate::engine::code) const fn opcode(self) -> PinnedOpcode {
        self.opcode
    }
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ImageRelocation {
    operand_offset: u32,
    atom: ImageAtom,
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ImageCode {
    bytes: Box<[u8]>,
...
impl ImageCode {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn as_bytes(&self) -> &[u8] {
        &self.bytes
    }

    #[must_use]
    pub(in crate::engine::code) const fn instructions(&self) -> &[ImageInstructionSpan] {
        &self.instructions
    }

    #[must_use]
    pub(in crate::engine::code) const fn atom_relocations(&self) -> &[ImageRelocation] {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ImageLocalVariable {
    name: ImageAtom,
...
impl ImageLocalVariable {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn scope_next(&self) -> ScopeLink {
        self.scope_next
    }

    #[must_use]
    pub(in crate::engine::code) const fn variable_reference_index(&self) -> u16 {
        self.variable_reference_index
    }

    #[must_use]
    pub(in crate::engine::code) const fn flags(&self) -> LocalVariableFlags {
        self.flags
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ImageClosureVariable {
    name: ImageAtom,
    variable_index: u16,
...
impl ImageClosureVariable {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn variable_index(&self) -> u16 {
        self.variable_index
    }

    #[must_use]
    pub(in crate::engine::code) const fn flags(&self) -> ClosureVariableFlags {
        self.flags
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ImageFunctionDebug {
    filename: ImageAtom,
    pc2line: Box<[u8]>,
    source: Box<[u8]>,
}
...
impl ImageFunctionDebug {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn pc2line(&self) -> &[u8] {
        &self.pc2line
    }

    #[must_use]
    pub(in crate::engine::code) const fn source(&self) -> &[u8] {
        &self.source
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ImageFunctionEnvelope {
    flags: FunctionFlags,
    js_mode: JsMode,
    name: ImageAtom,
    argument_count: u16,
...
impl ImageFunctionEnvelope {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn flags(&self) -> FunctionFlags {
        self.flags
    }

    #[must_use]
    pub(in crate::engine::code) const fn js_mode(&self) -> JsMode {
        self.js_mode
    }
    ...
    #[must_use]
    pub(in crate::engine::code) const fn variable_count(&self) -> u16 {
        self.variable_count
    }
    ...
    #[must_use]
    pub(in crate::engine::code) const fn stack_size(&self) -> u16 {
        self.stack_size
    }

    #[must_use]
    pub(in crate::engine::code) const fn variable_reference_count(&self) -> u16 {
        self.variable_reference_count
    }

    #[must_use]
    pub(in crate::engine::code) const fn locals(&self) -> &[ImageLocalVariable] {
        &self.locals
    }

    #[must_use]
    pub(in crate::engine::code) const fn closures(&self) -> &[ImageClosureVariable] {
        &self.closures
    }

    #[must_use]
    pub(in crate::engine::code) const fn code(&self) -> &ImageCode {
        &self.code
    }

    #[must_use]
    pub(in crate::engine::code) const fn debug(&self) -> Option<&ImageFunctionDebug> {
        self.debug.as_ref()
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct FunctionRecord {
...
impl FunctionRecord {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn envelope(&self) -> &ImageFunctionEnvelope {
        &self.envelope
    }

    #[must_use]
    pub(in crate::engine::code) const fn constants(&self) -> &[ImageValue] {
        &self.constants
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ModuleRequest {
    name: ImageAtom,
...
impl ModuleRequest {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn attributes(&self) -> &ImageValue {
        &self.attributes
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ModuleExport {
...
impl ModuleExport {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn export_type(&self) -> u8 {
        match self.binding {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn local_variable_index(&self) -> Option<u32> {
        match self.binding {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn request_index(&self) -> Option<u32> {
        match self.binding {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ModuleImport {
    variable_index: u32,
    is_star: bool,
...
impl ModuleImport {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn variable_index(&self) -> u32 {
        self.variable_index
    }

    #[must_use]
    pub(in crate::engine::code) const fn is_star(&self) -> bool {
        self.is_star
    }
    ...
    #[must_use]
    pub(in crate::engine::code) const fn request_index(&self) -> u32 {
        self.request_index
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct ModuleRecord {
    name: ImageAtom,
...
impl ModuleRecord {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn requests(&self) -> &[ModuleRequest] {
        &self.requests
    }

    #[must_use]
    pub(in crate::engine::code) const fn exports(&self) -> &[ModuleExport] {
        &self.exports
    }

    #[must_use]
    pub(in crate::engine::code) const fn star_export_request_indices(&self) -> &[u32] {
        &self.star_export_request_indices
    }

    #[must_use]
    pub(in crate::engine::code) const fn imports(&self) -> &[ModuleImport] {
        &self.imports
    }

    #[must_use]
    pub(in crate::engine::code) const fn has_tla(&self) -> bool {
        self.has_tla
    }

    #[must_use]
    pub(in crate::engine::code) const fn func_obj(&self) -> &ImageValue {
        &self.func_obj
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct BytecodeImage {
    source: MachineSource,
...
impl BytecodeImage {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn input_atom_slot_count(&self) -> u32 {
        self.atoms.input_slot_count
    }

    /// Return the image-local dynamic strings indexed by `ImageAtom::Dynamic`.
    #[must_use]
    pub(in crate::engine::code) const fn atoms(&self) -> &[WireString] {
        &self.atoms.dynamic
    }
    ...
    pub(in crate::engine::code::binary_object) fn sab_archive_occurrences(
        &self,
    ...
    #[must_use]
    pub(in crate::engine::code) const fn reference_table(&self) -> &[NodeId] {
        &self.ref_table
    }

    #[must_use]
    pub(in crate::engine::code) const fn functions(&self) -> &[FunctionRecord] {
        &self.functions
    }

    #[must_use]
    pub(in crate::engine::code) fn function(&self, id: FunctionId) -> Option<&FunctionRecord> {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn modules(&self) -> &[ModuleRecord] {
        &self.modules
    }

    #[must_use]
    pub(in crate::engine::code) fn module(&self, id: ModuleId) -> Option<&ModuleRecord> {
        (id.source() == self.source)
    ...
    #[must_use]
    pub(in crate::engine::code) const fn root(&self) -> &ImageValue {
        &self.root
    }
}
