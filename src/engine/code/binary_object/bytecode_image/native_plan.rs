...
use crate::engine::code::binary_object::pinned_atoms::{FIRST_DYNAMIC_ATOM, PinnedAtomKind};
...
pub(in crate::engine::code::binary_object) enum NativeAtomClass {
    Null,
    Index,
    String,
    Private,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) struct NativeAtomRef<'image> {
...
impl<'image> NativeAtomRef<'image> {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn class(self) -> NativeAtomClass {
        match self.kind {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn index(self) -> Option<u32> {
        match self.kind {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn manifest_string(
        self,
    ) -> Option<&'static str> {
        match self.kind {
            NativeAtomRefKind::Manifest {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn dynamic_string(
        self,
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn identity_description(
        self,
    ) -> Option<&'static str> {
        match self.kind {
            NativeAtomRefKind::Manifest {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) struct NativeLabel {
    operand_pc: u32,
    displacement: i32,
    target_pc: u32,
...
impl NativeLabel {
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn operand_pc(self) -> u32 {
        self.operand_pc
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn displacement(self) -> i32 {
        self.displacement
    }
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn target_instruction(self) -> u32 {
...
pub(in crate::engine::code::binary_object) enum NativeOperands<'image> {
    None,
    NoneInt(i32),
    NoneLoc(u16),
    NoneArg(u16),
...
impl NativeOperands<'_> {
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn format(&self) -> OpcodeFormat {
        match self {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) struct NativeInstruction<'image> {
    byte_pc: u32,
    opcode: PinnedOpcode,
...
impl<'image> NativeInstruction<'image> {
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn byte_pc(&self) -> u32 {
        self.byte_pc
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn opcode(&self) -> PinnedOpcode {
        self.opcode
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn operands(&self) -> &NativeOperands<'image> {
        &self.operands
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) struct NativeCodePlan<'image> {
    function: FunctionId,
...
impl<'image> NativeCodePlan<'image> {
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn function(&self) -> FunctionId {
        self.function
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn instructions(
        &self,
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn native_pc_map(&self) -> &[u32] {
        &self.native_pc_map
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) fn instruction_at_native_pc(
        &self,
        byte_pc: u32,
    ) -> Option<u32> {
        self.native_pc_map
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum NativePlanError {
    FunctionNotInImage,
    InvalidOpcode {
        instruction: usize,
        byte_pc: u32,
...
impl NativePlanError {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn is_label_target_error(&self) -> bool {
        matches!(
            self,
...
pub(in crate::engine::code::binary_object) fn decode_native_code_plan<'image>(
...
mod tests {
    use super::*;
    use crate::engine::code::binary_object::bytecode_image::{
        BytecodeImageLimits, ImageInstructionSpan, ImageRelocation, ModuleLimits,
        decode_bytecode_image_body,
    };
    use crate::engine::code::binary_object::code::CodeLimits;
    use crate::engine::code::binary_object::function_envelope::FunctionEnvelopeLimits;

    use crate::engine::code::binary_object::graph::model::{AtomId, GraphLimits};
    use crate::engine::code::binary_object::pinned_atoms::PinnedAtomId;
    use crate::engine::code::binary_object::pinned_opcodes::PINNED_OPCODE_COUNT;

    use crate::engine::code::binary_object::wire::{ReaderMode, WireCursor, WireLimits};
