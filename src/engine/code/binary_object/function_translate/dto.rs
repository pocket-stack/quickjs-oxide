...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum OperandShape {
    None,
    NoneInt,
    NoneLoc,
    NoneArg,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum AtomOperandClass {
    Null,
    Index,
    String,
    Private,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum TranslationBlocker {
    InvalidSentinel,
    ValueConstruction,
    FunctionGraph,
    Completion,
...
pub(in crate::engine::code::binary_object) struct AtomStringUnits<'spelling> {
...
#[derive(Clone, Copy)]
pub(in crate::engine::code::binary_object) struct AtomOperand<'image> {
...
impl<'image> AtomOperand<'image> {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn class(&self) -> AtomOperandClass {
        match &self.value {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn index_value(&self) -> Option<u32> {
        match &self.value {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn string_utf16_len(&self) -> Option<usize> {
        match &self.value {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn string_utf16_units(
        &self,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum FunctionUnaryOp {
    Neg,
    Plus,
    Dec,
    Inc,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum FunctionStackOp {
    Drop,
    Nip,
    Dup,
    Dup1,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum FunctionBinaryOp {
    Add,
    Sub,
    Mul,
    Div,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum FunctionPredicateOp {
    IsUndefinedOrNull,
    IsUndefined,
    IsNull,
    TypeOfIsUndefined,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum FunctionApplyKind {
    Call,
    Construct,
}
...
#[derive(Clone, Debug)]
pub(in crate::engine::code::binary_object) enum FunctionOp<'image> {
...
pub(in crate::engine::code::binary_object) struct OperationDiagnostic {
    mnemonic: &'static str,
...
impl OperationDiagnostic {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn mnemonic(self) -> &'static str {
        self.mnemonic
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn operand_shape(self) -> OperandShape {
        self.operand_shape
    }
}
...
#[derive(Clone)]
pub(in crate::engine::code::binary_object) struct FunctionInstruction<'image> {
...
impl<'image> FunctionInstruction<'image> {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn supports_scalar(&self) -> bool {
        self.audience.includes_scalar()
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn supports_ordinary(&self) -> bool {
        self.audience.includes_ordinary()
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn rejection_diagnostic(
        &self,
    ) -> OperationDiagnostic {
        self.diagnostic
    }
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn operation(&self) -> &FunctionOp<'image> {
        &self.operation
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) fn into_operation(self) -> FunctionOp<'image> {
        self.operation
    }
}
...
#[derive(Clone)]
pub(in crate::engine::code::binary_object) struct FunctionCode<'image> {
...
impl<'image> FunctionCode<'image> {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn into_instructions(
        self,
