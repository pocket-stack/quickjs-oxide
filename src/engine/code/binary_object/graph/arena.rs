...
pub(in crate::engine::code::binary_object) enum ArenaError {
    Graph(GraphError),
...
pub(in crate::engine::code::binary_object) enum PendingNodeKind {
    Ordinary,
    Array,
    TemplateObject,
    TypedArray,
...
#[derive(Debug)]
pub(in crate::engine::code::binary_object) enum NodeState<'a, V, K> {
    Pending(PendingNodeKind),
...
pub(in crate::engine::code::binary_object) struct NodeReservation<'arena, V, K> {
...
impl<V, K> NodeReservation<'_, V, K> {
    pub(in crate::engine::code::binary_object) fn install_pending_node(
        self,
    ...
    pub(in crate::engine::code::binary_object) fn install_ready_node(
        self,
...
pub(in crate::engine::code::binary_object) struct ObjectArenaParts<V, K> {
    pub(in crate::engine::code::binary_object) nodes: Box<[WireNodeCarrier<V, K>]>,
    pub(in crate::engine::code::binary_object) ref_table: Box<[NodeId]>,
}

pub(in crate::engine::code::binary_object) struct ObjectArena<V, K> {
    limits: GraphLimits,
...
impl<V, K> ObjectArena<V, K> {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn len(&self) -> usize {
        self.slots.len()
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn allows_references(&self) -> bool {
        self.allow_references
    }

    pub(in crate::engine::code::binary_object) fn resolve_reference(
        &self,
        index: u32,
    ) -> Result<NodeId, ArenaError> {
    ...
    pub(in crate::engine::code::binary_object) fn node_state(
        &self,
        node: NodeId,
    ...
    pub(in crate::engine::code::binary_object) fn reserve_node(
        &mut self,
    ...
    pub(in crate::engine::code::binary_object) fn append_reference_alias(
        &mut self,
        node: NodeId,
    ) -> Result<(), ArenaError> {
    ...
    pub(in crate::engine::code::binary_object) fn complete_node(
        &mut self,
        node: NodeId,
...
mod tests {
    use super::*;
    use crate::engine::code::binary_object::graph::model::{WireKey, WireNode, WireValue};
