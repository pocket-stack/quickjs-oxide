...
pub(in crate::engine::code) struct ArchiveBackingId(u32);

impl ArchiveBackingId {
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn zero_based(self) -> u32 {
        self.0
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn as_usize(self) -> usize {
        self.0 as usize
    }
}
...
#[derive(Clone, Copy)]
pub(in crate::engine::code::binary_object) struct SabArchiveOccurrence {
    byte_length: u32,
...
impl SabArchiveOccurrence {
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn new(
        byte_length: u32,
        max_byte_length: Option<u32>,
        backing: ArchiveBackingId,
    ) -> Self {
...
impl<'a> SabTransportCursor<'a> {
    ...
    pub(in crate::engine::code::binary_object) fn read_u8(&mut self) -> Result<u8, WireError> {
        self.cursor_wire.read_u8()
    }

    pub(in crate::engine::code::binary_object) fn read_u16_le(&mut self) -> Result<u16, WireError> {
        self.cursor_wire.read_u16_le()
    }

    pub(in crate::engine::code::binary_object) fn read_bytes(
        &mut self,
        length: usize,
    ...
    pub(in crate::engine::code::binary_object) fn read_tag(&mut self) -> Result<BcTag, WireError> {
        self.cursor_wire.read_tag()
    }

    pub(in crate::engine::code::binary_object) fn read_uleb128(
        &mut self,
    ) -> Result<u32, WireError> {
        self.cursor_wire.read_uleb128()
    }

    pub(in crate::engine::code::binary_object) fn read_i32(&mut self) -> Result<i32, WireError> {
        self.cursor_wire.read_i32()
    }

    pub(in crate::engine::code::binary_object) fn read_f64(&mut self) -> Result<f64, WireError> {
        self.cursor_wire.read_f64()
    }

    pub(in crate::engine::code::binary_object) fn read_header(
        &mut self,
    ) -> Result<BinaryObjectHeader, WireError> {
        self.cursor_wire.read_header()
    }

    pub(in crate::engine::code::binary_object) fn read_string(
        &mut self,
...
pub(in crate::engine::code::binary_object) struct SharedBackingDescriptor {
    capacity: u32,
    growable: bool,
}
...
impl SharedBackingDescriptor {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) const fn capacity(self) -> u32 {
        self.capacity
    }

    #[must_use]
    pub(in crate::engine::code::binary_object) const fn is_growable(self) -> bool {
        self.growable
    }
}
...
pub(in crate::engine::code::binary_object) enum SabArchiveError {
    Wire(WireError),
    Graph(GraphError),
