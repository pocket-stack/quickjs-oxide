...
pub(in crate::engine::code) use super::sab_transport::ArchiveBackingId;

/// Zero-based index into [`WireGraph::nodes`].
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub(in crate::engine::code) struct NodeId(pub(in crate::engine::code) u32);
...
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub(in crate::engine::code) struct AtomId(pub(in crate::engine::code) u32);
...
pub(in crate::engine::code) enum WireKey {
...
#[must_use]
pub(in crate::engine::code) fn numeric_atom_index(value: &WireString) -> Option<u32> {
...
#[must_use]
pub(in crate::engine::code) fn semantic_atom_eq(left: &WireString, right: &WireString) -> bool {
    left.len() == right.len()
...
/// [`semantic_atom_eq`].
pub(in crate::engine::code) fn semantic_atom_hash<H: Hasher>(value: &WireString, state: &mut H) {
...
pub(in crate::engine::code) struct WirePropertyCarrier<V, K> {
    pub(in crate::engine::code) key: K,
    pub(in crate::engine::code) value: V,
}

/// One property in the concrete data-object graph.
pub(in crate::engine::code) type WireProperty = WirePropertyCarrier<WireValue, WireKey>;

/// A heap-independent JavaScript value held by a wire graph.
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum WireValue {
    Undefined,
    Null,
    Bool(bool),
    Int32(i32),
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct BoxedPrimitive(WireValue);

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum BoxedPrimitiveError {
    NullOrUndefined,
    Object,
}
...
impl BoxedPrimitive {
    pub(in crate::engine::code) fn try_from_wire_value(
        value: WireValue,
    ...
    #[must_use]
    pub(in crate::engine::code) const fn as_wire_value(&self) -> &WireValue {
        &self.0
    }
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct DateNumber(WireValue);

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum DateNumberError {
    NotNumber,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(u8)]
pub(in crate::engine::code) enum TypedArrayKind {
    Uint8Clamped = 0,
    Int8 = 1,
    Uint8 = 2,
    Int16 = 3,
...
impl TypedArrayKind {
    pub(in crate::engine::code) const COUNT: usize = 12;
    pub(in crate::engine::code) const ALL: [Self; Self::COUNT] = [
        Self::Uint8Clamped,
        Self::Int8,
        Self::Uint8,
        Self::Int16,
    ...
    #[must_use]
    pub(in crate::engine::code) const fn from_wire_byte(value: u8) -> Option<Self> {
        match value {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn to_wire_byte(self) -> u8 {
        self as u8
    }

    #[must_use]
    pub(in crate::engine::code) const fn element_byte_length(self) -> u8 {
        match self {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum WireNodeCarrier<V, K> {
...
pub(in crate::engine::code) type WireNode = WireNodeCarrier<WireValue, WireKey>;

/// Pinned QuickJS currently rejects ArrayBuffer lengths above 2 GiB - 1.
pub(in crate::engine::code) const MAX_ARRAY_BUFFER_BYTE_LENGTH: u32 = i32::MAX as u32;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum ArrayBufferLayoutError {
    ByteLengthTooLarge {
        byte_length: usize,
        maximum: u32,
    },
...
pub(in crate::engine::code) fn validate_array_buffer_layout(
    byte_length: usize,
    max_byte_length: Option<u32>,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum TypedArrayLayoutError {
    UnalignedByteOffset {
        byte_offset: u32,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum TypedArrayBackingError {
    NotObject,
    Pending { node: NodeId },
...
pub(in crate::engine::code) fn validate_typed_array_layout(
    kind: TypedArrayKind,
    length: u32,
    byte_offset: u32,
    backing_byte_length: usize,
...
pub(in crate::engine::code) fn validate_typed_array_write_layout(
    kind: TypedArrayKind,
    length: u32,
    byte_offset: u32,
    backing_byte_length: usize,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct WireGraph {
    ...
    pub(in crate::engine::code) atoms: Box<[WireString]>,
    pub(in crate::engine::code) nodes: Box<[WireNode]>,
    ...
    pub(in crate::engine::code) ref_table: Box<[NodeId]>,
    pub(in crate::engine::code) root: WireValue,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) struct GraphLimits {
    max_nodes: usize,
...
impl GraphLimits {
    ...
    #[must_use]
    pub(in crate::engine::code) const fn with_shared_array_buffers(
        mut self,
    ...
    #[must_use]
    pub(in crate::engine::code) const fn limit(self, kind: GraphResourceKind) -> usize {
        match kind {
    ...
    pub(in crate::engine::code) fn check(
        self,
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum GraphResourceKind {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code) enum GraphError {
    ResourceLimit {
        kind: GraphResourceKind,
        requested: usize,
        limit: usize,
...
#[must_use]
pub(in crate::engine::code) fn canonical_bigint_length(payload: &[u8]) -> usize {
