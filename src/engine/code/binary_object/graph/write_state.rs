...
pub(in crate::engine::code::binary_object) enum DataNodeWrite {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum DataPlanNodeWrite {
    Reference,
    Traverse,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::engine::code::binary_object) enum DataWriteStateError {
    Graph(GraphError),
...
pub(in crate::engine::code::binary_object) struct DataWriteState {
    limits: GraphLimits,
...
pub(in crate::engine::code::binary_object) struct UniqueNodeReservation<'state> {
    unique_nodes: &'state mut HashSet<NodeId>,
    node: NodeId,
}

impl UniqueNodeReservation<'_> {
    pub(in crate::engine::code::binary_object) fn commit(self) {
...
impl DataWriteState {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn for_plan(
        limits: GraphLimits,
        allow_object_references: bool,
    ) -> Self {
        Self::with_references(
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn for_emission(
        limits: GraphLimits,
        allow_object_references: bool,
    ) -> Self {
    ...
    #[must_use]
    pub(in crate::engine::code::binary_object) fn allows_object_references(&self) -> bool {
        !matches!(self.references, ObjectReferenceState::Disabled)
    }

    pub(in crate::engine::code::binary_object) fn enter_node(
        &mut self,
        node: NodeId,
    ...
    pub(in crate::engine::code::binary_object) fn enter_plan_node(
        &mut self,
        node: NodeId,
    ...
    pub(in crate::engine::code::binary_object) fn leave_node(&mut self, node: NodeId) {
        let was_active = self.active_nodes.remove(&node);
        debug_assert!(was_active);
    }

    pub(in crate::engine::code::binary_object) fn child_depth(
        &self,
        parent_depth: usize,
    ...
    pub(in crate::engine::code::binary_object) fn reserve_unique_node(
        &mut self,
        node: NodeId,
    ...
    pub(in crate::engine::code::binary_object) fn record_unique_node(
        &mut self,
        node: NodeId,
    ...
    pub(in crate::engine::code::binary_object) fn check_container_entries(
        &self,
        entry_count: usize,
    ...
    pub(in crate::engine::code::binary_object) fn charge_container_entries(
        &mut self,
        entry_count: usize,
    ) -> Result<(), DataWriteStateError> {
    ...
    pub(in crate::engine::code::binary_object) fn check_bigint_bytes(
        &self,
        byte_length: usize,
    ) -> Result<(), DataWriteStateError> {
        self.limits
    ...
    pub(in crate::engine::code::binary_object) fn charge_bigint_bytes(
        &mut self,
        byte_length: usize,
    ) -> Result<(), DataWriteStateError> {
        Self::charge_aggregate(
    ...
    pub(in crate::engine::code::binary_object) fn charge_array_buffer_bytes(
        &mut self,
        byte_length: usize,
    ) -> Result<(), DataWriteStateError> {
        self.limits
