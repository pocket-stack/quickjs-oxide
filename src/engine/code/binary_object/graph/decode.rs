...
use crate::engine::value::bigint::BC5_BIGINT_READ_MAX_BYTES;
...
pub(in crate::engine::code) use super::sab_transport::decode_graph_with_sab_transport;
...
pub(in crate::engine::code) enum DecodeError<Opaque = Infallible> {
    Wire(WireError),
    Graph(GraphError),
    AtomCountOverflow {
        atom_count: usize,
...
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub(in crate::engine::code::binary_object) struct MachineSource(MachineId);
...
pub(in crate::engine::code::binary_object) trait DataValue:
    sealed::Sealed + Sized
{
...
pub(in crate::engine::code::binary_object) struct DataCompletion<V> {
    owner: MachineId,
    value: V,
}
...
pub(in crate::engine::code::binary_object) trait DataCursor<'input>:
...
pub(in crate::engine::code) fn decode_graph(
    input: &[u8],
    mode: ReaderMode,
...
pub(in crate::engine::code::binary_object) struct DataMachine<V, K> {
    id: MachineId,
    limits: GraphLimits,
...
{
    pub(in crate::engine::code::binary_object) fn new(
        limits: GraphLimits,
        allow_object_references: bool,
    ...
    pub(in crate::engine::code::binary_object) fn wrap_opaque_value(
        &self,
        value: V,
    ...
    pub(in crate::engine::code::binary_object) fn attach_to_frame(
        &self,
    ...
    pub(in crate::engine::code::binary_object) fn read_value_after_tag<'input, C>(
        &mut self,
        cursor: &mut C,
        tag: BcTag,
        tag_offset: usize,
    ...
    pub(in crate::engine::code::binary_object) fn finish_frame(
        &mut self,
        frame: DataFrame<V, K>,
    ) -> Result<DataCompletion<V>, DecodeError<V::Opaque>> {
        if frame.owner != self.id {
    ...
    pub(in crate::engine::code::binary_object) fn finish(
        self,
    ) -> Result<super::arena::ObjectArenaParts<V, K>, DecodeError<V::Opaque>> {
        self.arena.finish().map_err(Into::into)
    }

    pub(in crate::engine::code::binary_object) fn finish_output(
        self,
...
/// move.
pub(in crate::engine::code::binary_object) struct DataMachineOutput<V, K> {
    owner: MachineId,
...
where
    V: DataValue,
{
    pub(in crate::engine::code::binary_object) fn unwrap_completion(
        &self,
        completion: DataCompletion<V>,
    ) -> Result<V, DecodeError<V::Opaque>> {
...
pub(in crate::engine::code::binary_object) enum DataReadStep<V, K> {
...
pub(in crate::engine::code::binary_object) struct DataFrame<V, K> {
    owner: MachineId,
    ...
    K: Copy + Eq + std::hash::Hash,
{
    ...
    pub(in crate::engine::code::binary_object) fn expects_property_key(&self) -> bool {
        self.kind.expects_property_key()
    }

    pub(in crate::engine::code::binary_object) fn is_complete(&self) -> bool {
...
#[derive(Clone, Copy)]
pub(in crate::engine::code::binary_object) enum PropertyDisposition<K> {
    Define(K),
    Ignore,
}
...
mod tests {
    ...
    use super::*;
    use crate::engine::atom::ATOM_MAX_TABLE_INDEX;
