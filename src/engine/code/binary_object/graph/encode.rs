...
use crate::engine::atom::{ATOM_MAX_INT, ATOM_MAX_TABLE_INDEX};
...
pub(in crate::engine::code) struct GraphEncodeOptions {
...
pub(in crate::engine::code) enum GraphEncodeError {
    Graph(GraphError),
    Wire(WireError),
    AtomCountOverflow {
        atom_count: usize,
...
pub(in crate::engine::code) fn encode_graph(
    graph: &WireGraph,
