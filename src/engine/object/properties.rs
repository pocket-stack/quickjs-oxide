...
impl Runtime {
    ...
    #[cfg(test)]
    pub(crate) fn prepare_get_property(
        &self,
        object: &ObjectRef,
        key: &PropertyKey,
    ...
    #[cfg(test)]
    pub(crate) fn prepare_get_property_with_receiver(
        &self,
        object: &ObjectRef,
        key: &PropertyKey,
        receiver: Value,
    ...
    pub(crate) fn define_ordinary_own_property(
        &self,
        object: &ObjectRef,
        key: &PropertyKey,
        descriptor: &OrdinaryPropertyDescriptor,
    ...
    pub(crate) fn array_length_state_if_genuine(
        &self,
        object: &ObjectRef,
        ...
        if entry.flags.enumerable
            ...
            || entry.flags.storage != crate::engine::object::shape::PropertyStorageKind::Data
        {
            return Err(RuntimeError::Invariant(
    ...
    pub(crate) fn array_length_state(
        &self,
        object: &ObjectRef,
    ...
    pub(crate) fn array_length_value(length: u32) -> Value {
    ...
    pub(crate) fn validate_array_length_number(
        &self,
        realm: Option<ContextId>,
        value: f64,
    ...
    pub(crate) fn to_uint32_number(value: f64) -> u32 {
    ...
    pub(crate) fn is_auto_init_own_property(
        &self,
        object: &ObjectRef,
        key: &PropertyKey,
    ) -> Result<bool, RuntimeError> {
    ...
    pub(crate) fn own_property_is_enumerable(
        &self,
        object: &ObjectRef,
        key: &PropertyKey,
    ) -> Result<bool, RuntimeError> {
