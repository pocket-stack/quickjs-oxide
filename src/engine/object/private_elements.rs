...
impl Runtime {
    ...
    pub(crate) fn define_private_field_own(
        &self,
        receiver: &ObjectRef,
        name: &PrivateNameRef,
        value: Value,
    ...
    pub(crate) fn get_private_field_own(
        &self,
        receiver: &ObjectRef,
        name: &PrivateNameRef,
    ...
    pub(crate) fn set_private_field_own(
        &self,
        receiver: &ObjectRef,
        name: &PrivateNameRef,
        value: Value,
    ...
    /// prototype chain.
    pub(crate) fn has_private_field_own(
        &self,
        receiver: &ObjectRef,
        name: &PrivateNameRef,
    ...
    pub(crate) fn ensure_private_brand_home(
        &self,
    ...
    pub(crate) fn add_private_method_brand(
        &self,
        home_object: &ObjectRef,
        receiver: &ObjectRef,
    ) -> Result<(), RuntimeError> {
    ...
    pub(crate) fn check_private_method_brand(
        &self,
        method: &CallableRef,
        receiver: &ObjectRef,
        kind: ClosureVariableKind,
    ...
    pub(crate) fn require_private_method_brand(
        &self,
        method: &CallableRef,
        kind: ClosureVariableKind,
    ) -> Result<(), RuntimeError> {
