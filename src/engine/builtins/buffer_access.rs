...
use crate::engine::heap::{ArrayBufferState, ObjectId, ObjectKind};
...
/// its backing store.
pub(crate) struct BufferAccessToken {
    pub state: ArrayBufferState,
...
impl BufferAccessToken {
    ...
    pub(crate) fn shared_backing_id(&self) -> Option<u64> {
        match &self.backing {
...
impl Runtime {
    ...
    pub(crate) fn snapshot_buffer_access(
        &self,
        buffer: ObjectId,
    ...
    pub(crate) fn snapshot_buffer_access_if_branded(
        &self,
        object: &ObjectRef,
    ...
    pub(crate) fn with_buffer_range<R>(
        &self,
    ...
    pub(crate) fn with_buffer_range_mut<R>(
        &self,
        access: &BufferAccessToken,
        byte_offset: usize,
        byte_length: usize,
    ...
    pub(crate) fn write_buffer_word(
        &self,
        access: &BufferAccessToken,
        byte_offset: usize,
        bytes: &[u8],
    ...
    pub(crate) fn move_buffer_range(
        &self,
