...
#[derive(Clone, Copy)]
pub(crate) enum SubstitutionMatch<'a> {
...
pub(crate) struct SubstitutionInput<'a> {
    ...
    pub(crate) captures: Option<SubstitutionCaptures<'a>>,
    pub(crate) named_captures: Option<&'a ObjectRef>,
    pub(crate) replacement: &'a JsString,
}
