...
use crate::engine::builtins::native::{NativeFunctionId, WeakMapNativeKind, WeakSetNativeKind};
use crate::engine::heap::{
    ContextId, HeapError, ObjectData, ObjectId, ObjectPayload, RawValue, WeakCollectionKey,
    WeakMapRealmData, WeakSetRealmData,
};
...
impl Runtime {
    ...
    pub(crate) fn initialize_weak_collection_intrinsics(
        &self,
        realm: ContextId,
    ...
    pub(crate) fn call_weak_map_native(
        &self,
        realm: ContextId,
    ...
    pub(crate) fn call_weak_set_native(
        &self,
        realm: ContextId,
