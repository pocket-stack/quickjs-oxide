...
pub fn decode(input: &JsString, component: bool) -> Result<JsString, UriCodecError> {
...
pub fn encode(input: &JsString, component: bool) -> Result<JsString, UriCodecError> {
...
pub fn escape(input: &JsString) -> Result<JsString, UriCodecError> {
...
pub fn unescape(input: &JsString) -> Result<JsString, UriCodecError> {
