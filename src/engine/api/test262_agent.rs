...
impl Test262AgentSession {
    ...
    #[must_use]
    pub fn new(runtime_factory: fn() -> Runtime) -> Self {
        Self {
...
fn run_agent_worker(
    ...
    let runtime = (session.inner.runtime_factory)();
...
impl Runtime {
    pub(crate) fn new_registered_test262_agent_object(
        &self,
        realm: ContextId,
    ...
    pub(crate) fn call_test262_agent(
        &self,
        realm: ContextId,
