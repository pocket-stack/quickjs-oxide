...
/// injected failure.
#[cfg(test)]
pub fn fail_next_case_reservation_for_test() {
...
pub fn regexp_canonicalize(code_point: u32, unicode: bool) -> u32 {
    if code_point < 128 {
...
pub fn regexp_canonicalize_range_pairs(ranges: &[(u32, u32)], unicode: bool) -> Vec<(u32, u32)> {
...
pub fn convert_case_with_limit(
    input: &JsString,
    upper: bool,
    max_len: usize,
