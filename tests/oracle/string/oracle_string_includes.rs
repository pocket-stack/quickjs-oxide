...
fn string_includes_graph_and_autoinit_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String includes-family graph",
        GRAPH_CASES,
    );
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String includes-family AutoInit",
        AUTOINIT_CASES,
    );
}
...
fn string_includes_is_regexp_and_conversion_order_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String includes-family order",
        ORDER_CASES,
    );
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String includes-family RegExp",
        REGEXP_CASES,
    );
}
...
fn string_includes_exotic_surfaces_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String includes-family exotic surfaces",
        EXOTIC_CASES,
    );
}
...
fn string_includes_recursion_is_catchable_and_runtime_recovers() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String includes-family stack recovery",
        STACK_CASES,
    );
}
