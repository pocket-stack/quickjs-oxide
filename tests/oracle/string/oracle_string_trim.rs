...
fn string_trim_graph_descriptors_aliases_and_properties_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(CASE_PRELUDE, "String trim graph", GRAPH_CASES);
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String trim property behavior",
        PROPERTY_CASES,
    );
}
...
fn string_trim_utf16_lone_surrogates_astral_and_ropes_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(CASE_PRELUDE, "String trim UTF-16", UTF16_CASES);
}
...
fn string_trim_errors_and_nonconstructors_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(CASE_PRELUDE, "String trim errors", ERROR_CASES);
}
