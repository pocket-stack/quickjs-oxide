...
fn string_create_html_quote_only_escape_utf16_and_ropes_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String CreateHTML UTF-16 and escaping",
        UTF16_ESCAPE_CASES,
    );
}
...
fn string_create_html_conversion_order_ignored_extras_and_throw_identity_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String CreateHTML conversion order",
        ORDER_CASES,
    );
}
...
fn string_create_html_errors_and_nonconstructors_match_pinned_quickjs() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String CreateHTML errors",
        ERROR_CASES,
    );
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String CreateHTML construction",
        CONSTRUCT_CASES,
    );
}
...
fn string_create_html_recursion_is_catchable_shared_and_recovers() {
    compare_eval_completion_cases_with_prelude(
        CASE_PRELUDE,
        "String CreateHTML stack recovery",
        STACK_CASES,
    );
}
